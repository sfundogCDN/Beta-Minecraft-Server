...
public class GenLayerZoomVoronoi extends GenLayer
{
    ...
    public int[] a(int i, int j, int k, int l)
    {
        ...
        int l1 = (k >> byte0) + 3;
        int i2 = (l >> byte0) + 3;
        int ai[] = a.a(j1, k1, l1, i2);
        int j2 = l1 << byte0;
        int k2 = i2 << byte0;
        int ai1[] = IntCache.a(j2 * k2);
        for(int l2 = 0; l2 < i2 - 1; l2++)
        {
            ...
            for(int l3 = 0; l3 < l1 - 1; l3++)
            {
                ...
                a(l3 + j1 << byte0, l2 + k1 << byte0);
                double d1 = ((double)a(1024) / 1024D - 0.5D) * d;
                double d2 = ((double)a(1024) / 1024D - 0.5D) * d;
                a(l3 + j1 + 1 << byte0, l2 + k1 << byte0);
                double d3 = ((double)a(1024) / 1024D - 0.5D) * d + (double)i1;
                double d4 = ((double)a(1024) / 1024D - 0.5D) * d;
                a(l3 + j1 << byte0, l2 + k1 + 1 << byte0);
                double d5 = ((double)a(1024) / 1024D - 0.5D) * d;
                double d6 = ((double)a(1024) / 1024D - 0.5D) * d + (double)i1;
                a(l3 + j1 + 1 << byte0, l2 + k1 + 1 << byte0);
                double d7 = ((double)a(1024) / 1024D - 0.5D) * d + (double)i1;
                double d8 = ((double)a(1024) / 1024D - 0.5D) * d + (double)i1;
